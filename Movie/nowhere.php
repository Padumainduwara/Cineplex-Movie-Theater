                ...
                <div class="movie-card-content">
                    <section class="movie-details">
                        <div class="movie-poster">
                            <img src="../images/movie6.jpg" alt="Movie Poster">
                        </div>
                        <div class="movie-info">
                            <h1>Nowhere 2023</h1>
                            <br>
                            <p><strong>Genre:</strong> Drama , Triller</p>
                            ...
                            <p><strong>Synopsis:</strong> <br> <br>A young pregnant woman named Mia escapes from a country at war by hiding in a maritime container aboard a cargo ship. After a violent storm, Mia gives birth to her child while lost at sea,
                    ...
                    <section class="additional-details">
                        ...
                        <ul>
                            ...
                            <li><strong>Language:</strong> Spanish</li><br>
                            <li><strong>Country:</strong> Spain</li><br>
                        </ul>
                    ...
                    <div class="trailer-container">
                        <iframe width="560" height="315" src="Video/Nowhere.mp4" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
