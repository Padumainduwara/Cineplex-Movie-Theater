                ...
                <div class="movie-card-content">
                    <section class="movie-details">
                        <div class="movie-poster">
                            <img src="../images/movie11.jpg" alt="Movie Poster">
                        </div>
                        <div class="movie-info">
                            <h1>Law of Return 2023</h1>
                            <br>
                            <p><strong>Genre:</strong> Action, Drama, War</p>
                            <p><strong>Release Date:</strong> April 28, 2023 </p>
                            ...
                            <p><strong>Synopsis:</strong> <br> <br> Ronan, a fighter pilot and Israeli by Law of Return, is shot down and captured in Syria after a mission. As he's a US senator's son, a joint Israeli US squad's sent in to rescue Ronan within
                                36 hours.
                            </p>
                            <br>
                    ...
                    <section class="additional-details">
                        ...
                        <br>
                        <ul>
                            <li><strong>Director:</strong> Eli Roth </li><br>
                            <li><strong>Cast:</strong> Anna Castillo, Tony Corvillo, Tamar Novas</li><br>
                            <li><strong>Running Time:</strong> 2 hours 8 minutes</li><br>
                            <li><strong>Language:</strong> English</li><br>
                            <li><strong>Country:</strong> China</li><br>
                        </ul>
                    ...
                    <div class="trailer-container">
                        <iframe width="560" height="315" src="Video/Borntofly.mp4" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
