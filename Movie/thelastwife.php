                ...
                <div class="movie-card-content">
                    <section class="movie-details">
                        <div class="movie-poster">
                            <img src="../images/movie8.jpg" alt="Movie Poster">
                        </div>
                        <div class="movie-info">
                            <h1>The Last Wife 2024</h1>
                            <br>
                            ...
                            <p><strong>Synopsis:</strong> <br> <br> During the Nguyen Dynasty, a reluctant wife's life takes a dramatic turn when she had a chance encounter her childhood lover.
                            </p><br>
                    ...
                    <section class="additional-details">
                        ...
                        <br>
                        <ul>
                            <li><strong>Director:</strong> Victor Vu </li><br>
                            <li><strong>Cast:</strong> Anna Castillo, Tony Corvillo, Tamar Novas</li><br>
                            <li><strong>Running Time:</strong> 2 hours 12 minutes</li><br>
                            <li><strong>Language:</strong> Vietnamese</li><br>
                            <li><strong>Country:</strong> Vietnam</li><br>
                        </ul>
                    ...
                    <div class="trailer-container">
                        <iframe width="560" height="315" src="Video/lastwife.mp4" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
