                ...
                <div class="movie-card-content">
                    <section class="movie-details">
                        <div class="movie-poster">
                            <img src="../images/movie4.jpg" alt="Movie Poster">
                        </div>
                        <div class="movie-info">
                            <h1>Thanksgiving 2023</h1>
                            <br>
                            <p><strong>Genre:</strong> Horror, Mystery, Triller</p>
                            <p><strong>Release Date:</strong> November 17, 2023 </p>
                            ...
                            <p><strong>Synopsis:</strong> <br> <br> After a Black Friday riot ends in tragedy, a mysterious Thanksgiving-inspired killer terrorizes Plymouth, Massachusetts - the birthplace of the infamous holiday.
                    ...
                    <div class="trailer-container">
                        <iframe width="560" height="315" src="Video/Thanksgiving.mp4" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
