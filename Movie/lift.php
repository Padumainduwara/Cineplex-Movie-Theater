                ...
                <div class="movie-card-content">
                    <section class="movie-details">
                        <div class="movie-poster">
                            <img src="../images/movie1.jpg" alt="Movie Poster">
                        </div>
                        <div class="movie-info">
                            <h1>Lift 2024</h1>
                            <br>
                            <p><strong>Genre:</strong> Action , Comedy, Crime</p>
                            <p><strong>Release Date:</strong> January 12, 2025 </p>
                            ...
                            <p><strong>Synopsis:</strong> <br> <br> Follows a master thief and his Interpol Agent ex-girlfriend who team up to steal $500 million in gold bullion being transported on an A380 passenger flight.</p>
                            <br>
                    ...
                    <section class="additional-details">
                        ...
                        <br>
                        <ul>
                            <li><strong>Director:</strong> F. Gary Gray </li><br>
                            <li><strong>Cast:</strong> Anna Castillo, Tony Corvillo, Tamar Novas</li><br>
                            <li><strong>Running Time:</strong> 1 hours 47 minutes</li><br>
                            <li><strong>Language:</strong> English, Italian</li><br>
                    ...
                    <div class="trailer-container">
                        <iframe width="560" height="315" src="Video/lift.mp4" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
