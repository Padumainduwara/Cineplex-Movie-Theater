                ...
                <div class="movie-card-content">
                    <section class="movie-details">
                        <div class="movie-poster">
                            <img src="../images/movie2.jpg" alt="Movie Poster">
                        </div>
                        <div class="movie-info">
                            <h1>Role Play 2023</h1>
                            <br>
                            <p><strong>Genre:</strong> Action, Comedy, Romance</p>
                            <p><strong>Release Date:</strong> January 12, 2024 </p>
                            ...
                            <p><strong>Synopsis:</strong> <br> <br>Emma has a wonderful husband and two kids in the suburbs of New Jersey. She also has a secret life as an assassin for hire, a secret that her husband Dave discovers when the couple decide to spice up their marriage with a little role play.
                    ...
                    <section class="additional-details">
                        ...
                        <br>
                        <ul>
                            <li><strong>Director:</strong> Albert Pinto </li><br>
                            <li><strong>Cast:</strong> Anna Castillo, Tony Corvillo, Tamar Novas</li><br>
                            <li><strong>Running Time:</strong> 2 hours 15 minutes</li><br>
                    ...
                    <div class="trailer-container">
                        <iframe width="560" height="315" src="Video/Roleplay.mp4" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
