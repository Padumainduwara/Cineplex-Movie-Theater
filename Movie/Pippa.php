                ...
                <div class="movie-card-content">
                    <section class="movie-details">
                        <div class="movie-poster">
                            <img src="../images/movie9.jpg" alt="Movie Poster">
                        </div>
                        <div class="movie-info">
                            <h1>Pippa 2024</h1>
                            <br>
                            <p><strong>Genre:</strong> Action, History, Drama</p>
                            <p><strong>Release Date:</strong> April 12, 2024 </p>
                            ...
                            <p><strong>Synopsis:</strong> <br> <br> A young Indian Army captain from the 45 Cavalry regiment commanding the amphibious PT-76 war tank comes of age as he and his two siblings fight to liberate Bangladesh in the Indo-Pakistani war of 1971.
                        </p>
                            <br>
                    ...
                    <section class="additional-details">
                        ...
                        <br>
                        <ul>
                            <li><strong>Director:</strong> Raja Menon </li><br>
                            <li><strong>Cast:</strong> Anna Castillo, Tony Corvillo, Tamar Novas</li><br>
                            <li><strong>Running Time:</strong> 2 hours 19 minutes</li><br>
                            <li><strong>Language:</strong> Hindi</li><br>
                            <li><strong>Country:</strong> India</li><br>
                        </ul>
                    ...
                    <div class="trailer-container">
                        <iframe width="560" height="315" src="Video/pippa.mp4" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
