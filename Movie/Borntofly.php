                ...
                <div class="movie-card-content">
                    <section class="movie-details">
                        <div class="movie-poster">
                            <img src="../images/movie7.jpg" alt="Movie Poster">
                        </div>
                        <div class="movie-info">
                            <h1>Born to Fly 2023</h1>
                            <br>
                            ...
                            <p><strong>Synopsis:</strong> <br> <br> A special operations team headed by elite pilots are ordered to test new fighter jets. Test flight after test flight, they challenge the limits of the sky and themselves.
                            </p>
                            <br>
